    ...
    return Row(
      ...
      children: [
        CircleAvatar(
          ...
          radius: 79,
          child: CircleAvatar(backgroundImage: photo != '' ? NetworkImage(photo) : null, backgroundColor: Colors.white, radius: 72),
        ),
        Column(
          children: [
            Text(groupName),
            Row(children: [Text('Putaran ke'), Text(round)]),
            Row(children: [Text('Deadline'), Text(deadline)]),
            Row(children: [Text('Progress total'), Text(progress)]),
            Row(children: [Text('Progress Anda'), Text(yourProgress)])
          ],
        )
      ],
    );
