const String ApiDomain = 'https://khotmil.digitalamalindonesia.com/wp-json/';
...
const String NickNameChecking = 'Mohon tunggu, memeriksa nama panggilan Anda';
const String NickNameExistShort = 'Nama panggilan sudah digunakan';
const String NickNameExistMessage = 'Nama panggilan tidak tersedia, silahkan pilih nama lain.';
...
const String EditPhotoText = 'Sentuh photo untuk mengganti';
...
const String InviteMember = 'Undang Anggota';
...
const String ButtonQuitJuz = 'Keluar Juz';
...
const String LeaveGroupWarningTitle = 'Keluar Group?';
const String LeaveGroupWarning = 'Anda yakin akan keluar dari group ini?\n\nAnda bisa bergabung kembali lewat fitur Gabung Group.';
const String LeaveGroupConfirm = 'Keluar';

const String AdminsGroups = 'Admin Group';
const String QuitAdminsGroupsWarning = "Anda yakin ingin berhenti sebagai admin di group %s?";
const String QuitAdminsGroupsSuccess = 'Berhenti sebagai admin berhasil';
